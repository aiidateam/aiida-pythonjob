...
class Singlefile:
    ...
    @classmethod
    def from_string(cls, content: str, filename: str | pathlib.Path | None = None, **kwargs: t.Any) -> "Singlefile":
    ...
    @classmethod
    def from_bytes(cls, content: bytes, filename: str | pathlib.Path | None = None, **kwargs: t.Any) -> "Singlefile":
        """Construct a new instance and set ``content`` as its contents.
    ...
    def __init__(
        ...
        **kwargs: t.Any,
        ...
        :param file: an absolute filepath or filelike object whose contents to copy.
            Hint: Pass io.BytesIO(b"my string") to construct the Singlefile directly from a string.
